...
export const ru: Record<string, string> = {
  ...
  "why.4.body":
    "Вопрос уходит сразу трём разным моделям. Каждая сама читает ваши файлы и не видит двух других. Судья читает все три отчёта, задаёт уточняющие вопросы там, где они расходятся, и пишет один ответ. Если одну и ту же проблему нашли все три, на ней сошлись три независимые проверки. Если они разошлись, разбирается судья, а не вы.",
