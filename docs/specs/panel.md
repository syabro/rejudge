...
- [ ] PNL-006 Inner-agent runner on a single model		#poc
...
- [ ] PNL-007 Fan out the identical task to three panel agents		#poc
...
- [ ] PNL-008 All-or-nothing fusion success		#poc
...
- [ ] PNL-009 End-to-end demo on one project question		#poc
